...
cp coffeelinux/opt/coffeewall04.jpg /mnt/usr/share/backgrounds/coffee/ &&
cp coffeelinux/opt/coffeewall05.jpg /mnt/usr/share/backgrounds/coffee/ &&
cp coffeelinux/opt/coffeewall06.jpg /mnt/usr/share/backgrounds/coffee/ &&
cp coffeelinux/opt/coffeewall07.jpg /mnt/usr/share/backgrounds/coffee/ &&
...
echo "This script must be run as via sudo bash only"
echo "If you have not ran with sudo bash, please exit now."
