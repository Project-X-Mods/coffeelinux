...
arch-chroot /mnt pacman -Sy yay-git lib32-vulkan-mesa-layers libva-mesa-driver mesa-vdpau vulkan-mesa-layers gamescope mangohud steam-jupiter-stable zenity-light discord lib32-libva-mesa-driver lib32-mangohud lib32-mesa-vdpau mesa xorg-xwayland-jupiter egl-wayland qt6-wayland
