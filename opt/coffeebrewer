...
#Phase 5
echo 'Cleaning up' &&
cp -r /opt/chrome-flags.conf /mnt/home/$user01/.config/ && 
cp -r /opt/backgrounds/* /mnt/home/$user01/Pictures/ && 
cp -r /opt/backgrounds/* /mnt/usr/share/backgrounds/ && 
cp -r /opt/icons/* /mnt/usr/share/icons/ && 
cp -r /opt/themes/* /mnt/usr/share/themes/ && 
cp /opt/coffee.png /mnt/opt/ && 
cp /opt/chrome-flags.conf /mnt/opt/ &&
cp /opt/os-release /mnt/usr/lib/ && 
cp /opt/os-release /mnt/etc/ && 
cp /opt/coffeebrewer /mnt/usr/local/bin/ && 
cp /opt/chrome-pnkcfpnngfokcnnijgkllghjlhkailce-Default.desktop /mnt/opt/ &&
cp /opt/chrome-pnkcfpnngfokcnnijgkllghjlhkailce-Default.desktop /mnt/home/$user01/Desktop/ && 
cp /opt/chrome-pnkcfpnngfokcnnijgkllghjlhkailce-Default.desktop /mnt/home/$user01/.local/share/applications/ &&
cp /opt/CoffeeBrewer.desktop /mnt/home/$user01/Desktop/ && 
umount -R /mnt &&
...
setlocale && 
arch-chroot /mnt pacman -Sy git gnome-menus polkit-gnome gnome gdm gtk4 qt6 gnome-extra gnome-keyring base-devel cinnamon lightdm lightdm-gtk-greeter gnome-terminal gnome-disk-utility gnome-calculator cinnamon-translations gnome-system-monitor xed xreader vlc gnome-keyring cinnamon-translations archlinux-wallpaper udev dbus gstreamer systemd ntp gst-libav gst-plugins-base gst-plugins-good gst-plugins-ugly gst-plugins-bad sudo nano && 
echo 'Creating Links' && 
